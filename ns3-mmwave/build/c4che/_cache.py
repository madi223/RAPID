...
CC = ['/misc/opt/gcc/7.3.0/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-Wall', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
CXX = ['/misc/opt/gcc/7.3.0/bin/g++']
CXXFLAGS = ['-Wall', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11']
...
DEFINES = ['NS3_BUILD_PROFILE_OPTIMIZED', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_IF_TUN_H=1', 'HAVE_=1']
...
ENABLE_GTK2 = '-pthread -I/usr/include/gtk-2.0 -I/usr/lib64/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/harfbuzz -I/usr/include/freetype2 -I/usr/include/libpng15 -I/usr/include/pixman-1 -I/usr/include/libdrm  -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfontconfig -lgobject-2.0 -lglib-2.0 -lfreetype  \n'
...
EXAMPLE_DIRECTORIES = ['tutorial', 'stats', 'bbr-tests', 'udp-client-server', 'error-model', 'udp', 'routing', 'energy', 'socket', 'wireless', 'matrix-topology', 'ipv6', 'tcp', 'naming', 'realtime', 'traffic-control']
...
INCLUDES_GTK2 = ['/usr/include/gtk-2.0', '/usr/lib64/gtk-2.0/include', '/usr/include/atk-1.0', '/usr/include/cairo', '/usr/include/gdk-pixbuf-2.0', '/usr/include/pango-1.0', '/usr/include/glib-2.0', '/usr/lib64/glib-2.0/include', '/usr/include/harfbuzz', '/usr/include/freetype2', '/usr/include/libpng15', '/usr/include/pixman-1', '/usr/include/libdrm']
...
LINK_CC = ['/misc/opt/gcc/7.3.0/bin/gcc']
LINK_CXX = ['/misc/opt/gcc/7.3.0/bin/g++']
...
NS3_EXECUTABLE_PATH = ['/home/mdiarra/RAPID/ns3-mmwave/build/src/fd-net-device', '/home/mdiarra/RAPID/ns3-mmwave/build/src/tap-bridge']
...
cfg_files = ['/home/mdiarra/RAPID/ns3-mmwave/build/ns3/config-store-config.h', '/home/mdiarra/RAPID/ns3-mmwave/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
